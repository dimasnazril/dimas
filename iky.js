...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        ////DAFTAR BUTTON 
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan DimssBotz々 Verify Terlebih Dahulu Ya `
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6281337658551`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
│
│• *࿊⃟🐣* *Username:* ${pushname}
│• *࿊⃟🐣* *Bio Info:* ${thu.status}
│• *࿊⃟🐣* *User*: ${isPremium ? 'Premium User' : 'Free User'}
│• *࿊⃟🐣* *Admin*: ${isGroupAdmins ? 'Ya' : 'No'}
│• *࿊⃟🐣* *Level*: ${Levelnye}
│• *࿊⃟🐣* *XP*: ${Xpluu} / ${requiredXplu}
╰───────────────

╭─『 ❉ *BOT INFO* ❉』
│•
│• *࿊⃟🐣* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
│• *࿊⃟🐣* 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
...
*࿊⃟🦖* ${prefix}neon text
*࿊⃟🦖* ${prefix}greenneon text
*࿊⃟🦖* ${prefix}advanceglow text
*࿊⃟🦖* ${prefix}futureneon text
*࿊⃟🦖* ${prefix}sandwriting text
*࿊⃟🦖* ${prefix}sandsummer text
*࿊⃟🦖* ${prefix}sandengraved text
*࿊⃟🦖* ${prefix}metaldark text
*࿊⃟🦖* ${prefix}neonlight text
*࿊⃟🦖* ${prefix}holographic text
*࿊⃟🦖* ${prefix}text1917 text
*࿊⃟🦖* ${prefix}minion text
*࿊⃟🦖* ${prefix}deluxesilver text
*࿊⃟🦖* ${prefix}newyearcard text
*࿊⃟🦖* ${prefix}bloodfrosted text
*࿊⃟🦖* ${prefix}halloween text
*࿊⃟🦖* ${prefix}jokerlogo text
*࿊⃟🦖* ${prefix}fireworksparkle text
*࿊⃟🦖* ${prefix}natureleaves text
*࿊⃟🦖* ${prefix}bokeh text
*࿊⃟🦖* ${prefix}toxic text
*࿊⃟🦖* ${prefix}strawberry text
*࿊⃟🦖* ${prefix}box3d text
*࿊⃟🦖* ${prefix}roadwarning text
*࿊⃟🦖* ${prefix}breakwall text
*࿊⃟🦖* ${prefix}icecold text
*࿊⃟🦖* ${prefix}luxury text
*࿊⃟🦖* ${prefix}cloud text
*࿊⃟🦖* ${prefix}summersand text
*࿊⃟🦖* ${prefix}horrorblood text
*࿊⃟🦖* ${prefix}thunder text
*࿊⃟🦖* ${prefix}pornhub text1 text2
*࿊⃟🦖* ${prefix}glitch text1 text2
*࿊⃟🦖* ${prefix}avenger text1 text2
*࿊⃟🦖* ${prefix}space text1 text2
*࿊⃟🦖* ${prefix}ninjalogo text1 text2
*࿊⃟🦖* ${prefix}marvelstudio text1 text2
*࿊⃟🦖* ${prefix}lionlogo text1 text2
*࿊⃟🦖* ${prefix}wolflogo text1 text2
*࿊⃟🦖* ${prefix}steel3d text1 text2
*࿊⃟🦖* ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `DimssBotz々`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
*࿊⃟🕊️* smoke text
*࿊⃟🕊️* burnpaper text
*࿊⃟🕊️* lovemessage text
*࿊⃟🕊️* undergrass text
*࿊⃟🕊️* love text
*࿊⃟🕊️* coffe text
*࿊⃟🕊️* woodheart text
*࿊⃟🕊️* woodenboard text
*࿊⃟🕊️* summer3d text
*࿊⃟🕊️* wolfmetal text
*࿊⃟🕊️* nature3d text
*࿊⃟🕊️* underwater text
*࿊⃟🕊️* golderrose text
*࿊⃟🕊️* summernature text
*࿊⃟🕊️* letterleaves text
*࿊⃟🕊️* glowingneon text
*࿊⃟🕊️* fallleaves text
*࿊⃟🕊️* flamming text
*࿊⃟🕊️* harrypotter text
*࿊⃟🕊️* carvedwood text
*࿊⃟🕊️* tiktok text1 text2
*࿊⃟🕊️* arcade8bit text1 text2
*࿊⃟🕊️* battlefield4 text1 text2
*࿊⃟🕊️* pubg text1 text2
...
*࿊⃟🕊️* wetglass text
*࿊⃟🕊️* multicolor3d text
*࿊⃟🕊️* watercolor text
*࿊⃟🕊️* luxurygold text
*࿊⃟🕊️* galaxywallpaper text
*࿊⃟🕊️* lighttext text
*࿊⃟🕊️* beautifulflower text
*࿊⃟🕊️* puppycute text
*࿊⃟🕊️* royaltext text
*࿊⃟🕊️* heartshaped text
*࿊⃟🕊️* birthdaycake text
*࿊⃟🕊️* galaxystyle text
*࿊⃟🕊️* hologram3d text
*࿊⃟🕊️* greenneon text
*࿊⃟🕊️* glossychrome text
*࿊⃟🕊️* greenbush text
*࿊⃟🕊️* metallogo text
*࿊⃟🕊️* noeltext text
*࿊⃟🕊️* glittergold text
*࿊⃟🕊️* textcake text
*࿊⃟🕊️* starsnight text
*࿊⃟🕊️* wooden3d text
*࿊⃟🕊️* textbyname text
*࿊⃟🕊️* writegalacy text
*࿊⃟🕊️* galaxybat text
*࿊⃟🕊️* snow3d text
*࿊⃟🕊️* birthdayday text
*࿊⃟🕊️* goldplaybutton text
*࿊⃟🕊️* silverplaybutton text
*࿊⃟🕊️* freefire text
...
case 'chiisaihentai':
              ...
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'DimssBotz々', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @dimssganz_11`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Jangan Lupa Follow @dimssganz_11`},type:1}]
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'DimssBotz々T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @dimssganz_11`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
*࿊⃟🐣* 𝐆𝐫??𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*࿊⃟🐣* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : *${privat.length}*
*࿊⃟🐣* 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : *${totalChat.length}*
*࿊⃟🐣* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
*࿊⃟🐣* 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
*࿊⃟🐣* ??𝐥𝐚??𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
*࿊⃟🕊️*  ꜱᴇᴛᴘᴘɢʀᴜᴘ
*࿊⃟🕊️*  ꜱᴇᴛᴅᴇꜱᴄ
*࿊⃟🕊️*  ꜱɪᴅᴇʀ *ʀᴇᴘʟʏ ᴄʜᴀᴛ ʙᴏᴛ*
*࿊⃟🕊️*  ʜɪᴅᴇᴛᴀɢ *ᴛᴇᴋꜱ/ʀᴇᴘʟʏ ᴛᴇᴋꜱ*
...
`
 ...
 DimssBotz々`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
*࿊⃟🕊️* ${prefix}drakorongoing
*࿊⃟🕊️* ${prefix}lk21 query
*࿊⃟🕊️* ${prefix}wattpad url_wattpad
*࿊⃟🕊️* ${prefix}wattpadsearch query
*࿊⃟🕊️* ${prefix}cerpen
...
`
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
*࿊⃟🕊️* ${prefix}dropwater *teks*
*࿊⃟🕊️* ${prefix}blueneon *teks*
*࿊⃟🕊️* ${prefix}flowertext *teks*
*࿊⃟🕊️* ${prefix}tlight *teks*
*࿊⃟🕊️* ${prefix}epep *teks*
*࿊⃟🕊️* ${prefix}nulis *teks*
*࿊⃟🕊️* ${prefix}nulis2 *teks*
*࿊⃟🕊️* ${prefix}splaybutton *teks*
*࿊⃟🕊️* ${prefix}gplaybutton *teks*
*࿊⃟🕊️* ${prefix}cslogo *teks*
*࿊⃟🕊️* ${prefix}crismes *teks*
*࿊⃟🕊️* ${prefix}text3d *teks*
*࿊⃟🕊️* ${prefix}matrix *teks*
*࿊⃟🕊️* ${prefix}tfire *teks*
*࿊⃟🕊️* ${prefix}naruto *teks*
*࿊⃟🕊️* ${prefix}breakwall *teks*
*࿊⃟🕊️* ${prefix}flametext *teks*
*࿊⃟🕊️* ${prefix}sandw *teks*
...
*࿊⃟🐣* 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*࿊⃟🐣* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡??𝐭𝐬 : *${privat.length}*
*࿊⃟🐣* 𝐓????𝐚𝐥 𝐂𝐡𝐚??𝐬 : *${totalChat.length}*
*࿊⃟🐣* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
*࿊⃟🐣* 𝐀??𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
*࿊⃟🐣* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
*࿊⃟🐣* 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*࿊⃟🐣* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡??𝐭𝐬 : *${privat.length}*
*࿊⃟🐣* 𝐓𝐨??𝐚?? 𝐂𝐡𝐚𝐭𝐬 : *${totalChat.length}*
*࿊⃟🐣* 𝐒𝐩𝐞??𝐝 : *${latensie.toFixed(4)} _Second_*
*࿊⃟🐣* 𝐀𝐜𝐭𝐢𝐯?? : *${runtime(process.uptime())}*
*࿊⃟🐣* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
*࿊⃟🐣* 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*࿊⃟🐣* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : *${privat.length}*
*࿊⃟🐣* 𝐓𝐨??𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : *${totalChat.length}*
*࿊⃟🐣* 𝐒𝐩𝐞??𝐝 : *${latensie.toFixed(4)} _Second_*
*࿊⃟🐣* 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
*࿊⃟🐣* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated DimssBotz々`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*『 DimssBotz々 』*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Thank you for late registration DimssBotz々*`)
		}, 2000)
        break
case 'sfire':
{
...
┃💌 : *SERING² DONASI✨*
┃💌 : ==============
┃💌 : https://wa.me/message/G65XTLA2NIQNK1
┃💌 : ==============
┃💌 : Instagram : _*@dimssganz_11*_
┃💌 : YouTube : _*Dimss Ganz*_
┗━━⬣
`
...
🐋 Character : ${get_info.characters.join(", ")}\n`
      ...
      case 'kusonime':
       ...
       case 'nekopoi':
              ...
              get_result = get_result.result
              ini_txt = `\`\`\`*࿊⃟🐣* Title : ${get_result.anime}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Porducers : ${get_result.producers}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Duration : ${get_result.duration}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Size : ${get_result.size}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Sinopsis : ${get_result.sinopsis}\`\`\`\n`
       ...
       case 'nekopoisearch':
              ...
              ini_txt = ""
              for (var x of get_result) {
              ini_txt += `\`\`\`*࿊⃟🐣* Title : ${x.title}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Link : ${x.link}\`\`\`\n`
              ini_txt += `\`\`\`*࿊⃟🐣* Thumbnail : ${x.thumbnail}\`\`\`\n\n`
}
              reply(ini_txt)
              break
       case 'neko':
 ...
 **࿊⃟🐣* Judul :* ${res.all[0].title}
 *🐬 ID Video :* ${res.all[0].videoId}
 *🐋 Diupload Pada :* ${res.all[0].ago}
 **࿊⃟🐣* Views :* ${res.all[0].views}
...
teks += `\`\`\`*࿊⃟🐣* Nama : ${get_data[i].name}\`\`\`
\`\`\`*࿊⃟🐣* Harga : ${get_data[i].harga}\`\`\`
\`\`\`*࿊⃟🐣* Terjual : ${get_data[i].terjual}\`\`\`
\`\`\`*࿊⃟🐣* Lokasi : ${get_data[i].location}\`\`\`
\`\`\`*࿊⃟🐣* Deskripsi*: ${get_data[i].desc}\`\`\`
\`\`\`*࿊⃟🐣* Stok : ${get_data[i].stock}\`\`\`
\`\`\`*࿊⃟🐣* Informasi : ${get_data[i].information}\`\`\`
\`\`\`*࿊⃟🐣* Link : ${get_data[i].url}\`\`\``
}
...
teks += `\`\`\`*࿊⃟🐣* Title : ${get_result[i].title}\`\`\`
\`\`\`*࿊⃟🐣* Harga : ${get_result[i].price}\`\`\`
\`\`\`*࿊⃟🐣* Rate : ${get_result[i].rating}\`\`\`
\`\`\`*࿊⃟🐣* Link : ${get_result[i].url}\`\`\`
...
*Data Berhasil Didapatkan!*
\`\`\`*࿊⃟🐣* Username : ${ini_result.name}\`\`\`
\`\`\`*࿊⃟🐣* Public Repo : ${ini_result.public_repos}\`\`\`
\`\`\`*࿊⃟🐣* Public Gists : ${ini_result.public_gists}\`\`\`
\`\`\`*࿊⃟🐣* Pengikut : ${ini_result.followers}\`\`\`
\`\`\`*࿊⃟🐣* Following : ${ini_result.following}\`\`\`
\`\`\`*࿊⃟🐣* Mengikuti : ${ini_result.bio}\`\`\`
\`\`\`*࿊⃟🐣* Link : ${ini_result.url}\`\`\`
`
...
*Data Berhasil Didapatkan!*
\`\`\`*࿊⃟🐣* Username : ${ini_result.username}\`\`\`
\`\`\`*࿊⃟🐣* Nama : ${ini_result.fullname}\`\`\`
\`\`\`*࿊⃟🐣* Pengikut : ${ini_result.followers}\`\`\`
\`\`\`*࿊⃟🐣* Mengikuti : ${ini_result.following}\`\`\`
\`\`\`*࿊⃟🐣* Deskripsi : ${ini_result.bio}\`\`\`
\`\`\`*࿊⃟🐣* Link : https://instagram.com/${ini_result.username}\`\`\`
`
             ikyy.sendMessage(from, ini_buffer, image, { caption: ini_txt, thumbnail: Buffer.alloc(0) })
             break
      case 'stalktiktok':
...
*Data Berhasil Didapatkan!*
\`\`\`*࿊⃟🐣* Username : ${get_result.username}\`\`\`
\`\`\`*࿊⃟🐣* Nama : ${get_result.nickname}\`\`\`
\`\`\`*࿊⃟🐣* Pengikut : ${get_result.followers}\`\`\`
\`\`\`*࿊⃟🐣* Mengikuti : ${get_result.followings}\`\`\`
\`\`\`*࿊⃟🐣* Likes : ${get_result.likes}\`\`\`
\`\`\`*࿊⃟🐣* Video : ${get_result.video}\`\`\`
\`\`\`*࿊⃟🐣* Deskripsi : ${get_result.bio}\`\`\`
`
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `𝐎𝐖𝐍𝐄𝐑👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
      ...
      case 'stat':
              ...
              total = math(`${groups.length}*${privat.length}`)
teks = `\`\`\`BOT STATISTICS\`\`\`
\`\`\`*࿊⃟🐣* Group Chats : ${groups.length}\`\`\`
\`\`\`*࿊⃟🐣* Private Chats : ${privat.length}\`\`\`
\`\`\`*࿊⃟🐣* Total Chats : ${totalChat.length}\`\`\`
\`\`\`*࿊⃟🐣* Speed : ${latensie.toFixed(4)} _Second_\`\`\`
\`\`\`*࿊⃟🐣* Active Time : ${kyun(uptime)}\`\`\`

\`\`\`PHONE STATISTICS\`\`\`
\`\`\`*࿊⃟🐣* Baterai : ${baterai}% ${charger}\`\`\`
\`\`\`*࿊⃟🐣* Ram Usage : ${ram2}\`\`\`
\`\`\`*࿊⃟🐣* Platform : ${os.platform()}\`\`\`
\`\`\`*࿊⃟🐣* Hostname : ${os.hostname()}\`\`\`
\`\`\`*࿊⃟🐣* Uptime : ${runtime(process.uptime())}\`\`\`
\`\`\`*࿊⃟🐣* Wa Version: ${ikyy.user.phone.wa_version}\`\`\`
\`\`\`*࿊⃟🐣* Os Version: ${ikyy.user.phone.os_version}\`\`\`
\`\`\`*࿊⃟🐣* Device Manufacturer: ${ikyy.user.phone.device_manufacturer}\`\`\`
\`\`\`*࿊⃟🐣* Device Model: ${ikyy.user.phone.device_model}\`\`\`
\`\`\`*࿊⃟🐣* Os Build Number: ${ikyy.user.phone.os_build_number}\`\`\``
             reply(teks)
             break  
//------------------< Owner >-------------------
      case 'addupdate':
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*『 DimssBotz々 』*\n\n${body.slice(4)}`,
			"footerText": 'DimssBotz々',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://instagram.com/dimssganz_11?utm_medium=copy_link`)
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
